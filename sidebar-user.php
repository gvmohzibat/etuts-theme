<div id="post-meta-info">
    <div class="post-featured-image">
        <?php echo get_avatar( get_the_author_meta('email'), '320' ); ?>
        <h3 class="entry-title section-title background-border-title post-author-name-info"><span><?php echo get_the_author_meta('display_name'); ?></span></h3>
